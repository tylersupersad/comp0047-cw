...
input_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../data/raw/technology/technology_market_cap.csv"))
output_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../data/clean/technology/clean_technology_market_cap.csv"))
